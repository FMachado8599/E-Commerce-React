              ...
              {showQuantityDiv &&(
                ...
                <div className='quantityDiv'>
                  <button className="actionButton" onClick={() => handleDecreaseQuantity(producto)} >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-dash actionIcon" viewBox="0 0 16 16">
                      <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8"/>
                    </svg>
                  </button>
                  <p className='addedQuantity'>{quantity}</p>
                  <button className="actionButton" onClick={() => handleIncreaseQuantity(producto)} >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-plus actionIcon" viewBox="0 0 16 16">
